      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-800/80 shadow-2xl rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm mt-1">Sign in to your Task Management Dashboard</p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  } rounded-xl text-sm text-slate-100 placeholder-slate-600 focus:outline-none focus:ring-1 transition-all disabled:opacity-60`}
                />
              </div>
              {fieldErrors.email && (
