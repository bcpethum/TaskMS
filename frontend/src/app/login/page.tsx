      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-800/80 shadow-2xl rounded-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm mt-1">Sign in to access your Task Management Dashboard</p>
          </div>

          {/* Quick-fill Default Credentials Banner */}
          <div className="mb-6 bg-slate-800/50 border border-slate-700/60 rounded-xl p-3.5 text-xs text-slate-300">
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button
                ...
                className="text-xs bg-sky-500/20 hover:bg-sky-500/30 text-sky-300 font-medium px-2.5 py-1 rounded-md transition-colors"
              >
                Auto Fill
              </button>
            </div>
            <div className="font-mono text-slate-400 space-y-0.5">
              <div>Email: <span className="text-slate-200">admin@test.com</span></div>
              <div>Password: <span className="text-slate-200">123456</span></div>
            </div>
          </div>

          {/* Main Error Banner */}
          {errorMsg && (
            <div className="mb-6 bg-rose-500/10 border border-rose-500/20 rounded-xl p-3.5 text-rose-300 text-xs flex items-start gap-2.5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-2.5 bg-slate-950/60 border ${fieldErrors.email ? 'border-rose-500/80 focus:ring-rose-500' : 'border-slate-800 focus:border-sky-500 focus:ring-sky-500'
                    } rounded-xl text-sm text-slate-100 placeholder-slate-600 focus:outline-none focus:ring-1 transition-all`}
                />
              </div>
              {fieldErrors.email && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full pl-10 pr-4 py-2.5 bg-slate-950/60 border ${fieldErrors.password ? 'border-rose-500/80 focus:ring-rose-500' : 'border-slate-800 focus:border-sky-500 focus:ring-sky-500'
                    } rounded-xl text-sm text-slate-100 placeholder-slate-600 focus:outline-none focus:ring-1 transition-all`}
                />
              </div>
